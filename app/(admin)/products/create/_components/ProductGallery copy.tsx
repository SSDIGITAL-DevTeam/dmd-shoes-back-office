        ...
        {galleries.map((gallery) => (
          <div key={gallery.id} className="space-y-3">
            <div className="relative group">
              <div className="aspect-square border-2 border-gray-800 rounded-lg overflow-hidden bg-gray-100 p-2 flex items-center justify-center">
                {gallery.image ? (
                  <img
                    src={gallery.image}
                  ...
                  <label className="cursor-pointer flex flex-col items-center justify-center text-gray-500 text-sm hover:text-blue-500 transition">
                    <svg
                    ...
                    <input
                      ...
                      className="hidden"
                      onChange={(e) => onImageUpload(e, gallery.id)}
                    />
                  </label>
                )}
              </div>
