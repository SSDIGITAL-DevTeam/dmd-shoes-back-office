        ...
        {rows.map((c) => (
          <tr key={c.id} className="transition-colors hover:bg-gray-50">
            ...
            <td className="px-4 py-3 text-sm text-gray-700">
              {c.whatsapp_number?.trim() ? c.whatsapp_number : "-"}
            </td>
          </tr>
        ))}
      </tbody>
          ...
          <div className="flex items-center justify-end gap-2 border-b border-gray-200 px-4 py-3">
            <div className="relative">
              <input
                ...
                className="w-56 rounded-lg border border-gray-300 bg-white py-2 pl-9 pr-3 text-sm text-black placeholder:text-gray-400 shadow-sm outline-none transition focus:border-transparent focus:ring-2 focus:ring-amber-500"
              />
              <svg
